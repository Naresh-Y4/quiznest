const quizData = [
  {
    ...
    questions: [
      {
        question: "Which factor best contributes to overall mental wellbeing?",
        options: [
      ...
      {
        question: "Which of the following is the correct sequence of stages in the General Adaptation Syndrome?",
        options: [
      ...
      {
        question: "Which behaviour reflects healthy coping?",
        options: [
      ...
      {
        question: "What is a key characteristic of digital overload?",
        options: [
          "Mental exhaustion from excessive information",
          "Improved focus",
      ...
      {
        question: "Meher compares herself to influencers and feels inferior. Which theory explains this?",
        options: [
      ...
      {
        question: "Which of the following is an example of unhealthy social media behavior?",
        options: [
          "Learning new skills",
      ...
      },
      {
        ...
        options: [
          ...
          "Improve memory only",
          "Reduce physiological and mental tension",
          "Avoid responsibilities"
        ],
        answer: 2
      },
      {
        question: "Which practice helps in improving self-awareness?",
        options: [
      ...
      {
        question: "According to Piaget's theory, what is the 'imaginary audience'?",
        options: [
          "A group of friends who provide feedback on behavior",
          "The belief that others are constantly watching, noticing, and evaluating oneself",
          "The tendency to imitate people seen in the media",
  ...
  questions: [
    {
      ...
      options: [
        ...
        "Accepting and acknowledging one’s own or others’ emotions",
        "Controlling emotions completely",
        "Avoiding emotional discussions"
      ],
      answer: 1
    },
    {
      question: "What is the main purpose of emotional ventilation?",
      options: [
    ...
    {
      question: "Which skill is essential for emotional validation?",
      options: [
        "Judgment",
        "Active listening",
        "Avoidance",
    ...
    {
      question: "Emotional suppression can lead to:",
      options: [
    ...
    {
      question: "Which of the following is a type of boundary?",
      options: [
        "Financial boundary",
        "Emotional boundary",
        "Academic boundary",
    ...
    {
      question: "What is assertiveness in boundary setting?",
      options: [
        "Being aggressive",
        "Being passive",
    ...
    {
      question: "What helps in managing emotional overwhelm?",
      options: [
        "Ignoring stress",
    ...
    {
      question: "Emotional triggers are:",
      options: [
        "Random thoughts",
        "Situations that provoke emotional reactions",
    ...
    {
      question: "Emotional resilience refers to:",
      options: [
        "Avoiding emotions",
    ...
    {
      question: "Social support contributes to:",
      options: [
        "Increased stress",
